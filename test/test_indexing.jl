# Tests for indexing operations (range getindex/setindex!, VectorMPI indexing)
...
println(io0(), "[test] VectorMPI range partition consistency")
...
# ============================================================================
# Mixed Indexing Tests (VectorMPI + range/Colon)
# ============================================================================
...
println(io0(), "[test] MatrixMPI column extraction (A[:, k])")

M_col = M[:, 5]
@test M_col isa VectorMPI
@test length(M_col) == n


println(io0(), "[test] SparseMatrixMPI column extraction (A[:, k])")

A_col = A[:, 2]
@test A_col isa VectorMPI
@test length(A_col) == n
...
# ============================================================================
# Setindex! with mixed VectorMPI/range
# ============================================================================
